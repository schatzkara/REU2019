...
class FullNetwork(nn.Module):
    ...
    def forward(self, vp_diff, vid1, img2):
        ...
        """
        vp1_to_2 = self.exp(vp_diff)  # bsz,1/3,14,14

        exp_app_v2 = self.appearance_pipeline(img2)  # bsz,32,14,14

        rep_v2_est = self.action_pipeline(vp1_to_2, vid1)  # bsz,32,8/16,14,14
    ...
    def appearance_pipeline(self, img2):
        ...
        exp_app_v2 = self.expand_app_enc(app=app_v2)  # bsz,32,8/16,14,14
    ...
    def action_pipeline(self, vp_1_to_2, vid1):
        ...
        rep_v2_est = self.trans(trans_input2)  # bsz,32,8/16,14,14
