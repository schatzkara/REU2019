...
class KPPredictor(nn.Module):
    ...
    def __init__(self, stdev=0.1, kpp_name='Key-Point Predictor'):
        """
    ...
    def forward(self, x):
        ...
        out = f.interpolate(x, size=(16, 14, 14), mode='trilinear')
        x = f.interpolate(out, size=(16, 28, 28), mode='trilinear')
        ...
        gauss_heatmaps = nn.MaxPool3d(kernel_size=(1, 2, 2), stride=(1, 2, 2))(gauss_heatmaps)

        return out, gauss_heatmaps
