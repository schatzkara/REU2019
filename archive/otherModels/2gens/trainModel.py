...
def ntu_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weight_file = './weights/net2gens_ntu_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
...
def panoptic_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weight_file = './weights/net2gens_pan_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                       PRECROP, NUM_EPOCHS, LR)
...
def training_loop(epoch):
    ...
    for batch_idx, (vp_diff, vid1, vid2) in enumerate(trainloader):
        ...
        gen_v1, gen_v2, vid1shrunk, vid2shrunk, recon_v1, recon_v2, rep_v1, rep_v2, rep_v1_est, rep_v2_est = model(
            vp_diff=vp_diff,
            vid1=vid1, vid2=vid2,
            img1=img1, img2=img2)
        # loss
        ...
        recon3_loss = criterion(recon_v1, vid1shrunk)
        recon4_loss = criterion(recon_v2, vid2shrunk)
    ...
    print('Training Epoch {}/{} Loss:{} con1:{} con2:{} recon1:{} recon2:{} recon3:{} recon4:{}'.format(
        epoch + 1,
        NUM_EPOCHS,
        ...
        "{0:.5f}".format((running_recon3_loss / len(trainloader))),
        "{0:.5f}".format((running_recon4_loss / len(trainloader)))))
...
def testing_loop(epoch):
    ...
    print('Validation Epoch {}/{} Loss:{} con1:{} con2:{} recon1:{} recon2:{} recon3:{} recon4:{}'.format(
        epoch + 1,
        NUM_EPOCHS,
