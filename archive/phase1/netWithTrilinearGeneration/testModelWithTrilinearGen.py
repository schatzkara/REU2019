...
from networkWithTrilinearGen import FullNetwork
...
def ntu_config():
    ...
    weights_path = '/home/yogesh/kara/REU2019/phase0.5/weights/netbi_ntu_20_16_2_True_1000_0.0001.pt'
...
def panoptic_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weights_path = '/home/yogesh/kara/REU2019/phase0.5/weights/netbi_pan_20_16_2_False_1000_0.0001.pt'
