...
def ntu_config():
    ...
    weights_path = '/home/yogesh/kara/REU2019/phase0.5/weights/netrelu_ntu_20_16_2_True_1000_0.0001.pt'
    output_video_dir = './videos/ntu_relu_50epochs/'
...
def panoptic_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weights_path = '/home/yogesh/kara/REU2019/phase0.5/weights/netrelu_pan_20_16_2_False_1000_0.0001.pt'
    output_video_dir = './videos/pan_relu_50epochs/'
