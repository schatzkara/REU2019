...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, name='modified_inception_i3d', final_endpoint='Mixed_5c_small', in_frames=8, in_channels=3,
        ...
        ######## changed stride so temporal dim changes
        end_point = 'MaxPool3d_2a_3x3'
        self.end_points[end_point] = MaxPool3dSamePadding(kernel_size=[1, 3, 3], stride=(2, 2, 2),
                                                          padding=0)
        if self._final_endpoint == end_point: return
        ...
        ##############################
        # Modification: changed the stride of this max pooling layer so that only the temporal dimension changes.
