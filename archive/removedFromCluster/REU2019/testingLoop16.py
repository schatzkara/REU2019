...
from network_phase1 import FullNetwork
...
output_video_dir = '/home/yogesh/kara/REU2019/videos/16'  # 'C:/Users/Owner/Documents/UCF/Project/REU2019/videos'
...
def make_vid_path(vid_path, batch_num, vid_num, view):
    if not os.path.exists(vid_path):
        os.mkdir(vid_path)
        os.mkdir(os.path.join(vid_path, str(batch_num)))
        os.mkdir(os.path.join(vid_path, str(batch_num), str(vid_num)))
        os.mkdir(os.path.join(vid_path, str(batch_num), str(vid_num), str(view)))
    elif not os.path.exists(os.path.join(vid_path, str(batch_num))):
        os.mkdir(os.path.join(vid_path, str(batch_num)))
        os.mkdir(os.path.join(vid_path, str(batch_num), str(vid_num)))
        os.mkdir(os.path.join(vid_path, str(batch_num), str(vid_num), str(view)))
    elif not os.path.exists(os.path.join(vid_path, str(batch_num), str(vid_num))):
        os.mkdir(os.path.join(vid_path, str(batch_num), str(vid_num)))
        os.mkdir(os.path.join(vid_path, str(batch_num), str(vid_num), str(view)))
    elif not os.path.exists(os.path.join(vid_path, str(batch_num), str(vid_num), str(view))):
        os.mkdir(os.path.join(vid_path, str(batch_num), str(vid_num), str(view)))
    return os.path.join(vid_path, str(batch_num), str(vid_num), str(view))
