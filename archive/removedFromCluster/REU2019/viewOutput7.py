...
# vid_dir = '1pipeTrans/videos/pan_samepanel/'
# vid_dir = 'appSkipConns/videos/ntu_153e/'
# vid_dir = 'repSkipConns/videos/ntu_/'
# vid_dir = 'bothSkipConns/videos/ntu_/'
# vid_dir = 'repSkipConns/videos/ntu_/'
# vid_dir = 'lstmTrans/videos/ntu_109e/'
vid_dir = '7x7lstm/videos/ntu_86e/'
# vid_dir = 'diffAS/videos/ntu_/'

full_dir = os.path.join(root_dir, vid_dir)
print(full_dir)

batches_to_view = [166, 167]  # [274, 275, 276]  # [343, 344, 345]  # [207, 208, 209]  # [166, 167]  # None  # [208]  # range(165, 175)  # range(200, 210)  # range(80, 90)  #  [11, 15, 17, 18]
