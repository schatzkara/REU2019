...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, name='modified_inception_i3d', final_endpoint='Mixed_5c', in_frames=8, in_channels=3):
        ...
        # Modification: changed the stride of this max pooling layer so that only the temporal dimension gets smaller,
        ...
        self.end_points[end_point] = MaxPool3dSamePadding(kernel_size=[2, 2, 2], stride=(2, 1, 1),
                                                          padding=0)
        if self._final_endpoint == end_point: return
