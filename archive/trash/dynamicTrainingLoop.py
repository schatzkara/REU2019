# THIS VERSION ONLY BACK PROPS ON CON LOSS IF IT'S ABOVE A THRESHOLD
...
def train(epoch):
    ...
    for batch_idx, (view1vid, view2vid) in enumerate(trainloader):
        ...
        # accuracy
        # acc = compute_acc(output_v1, view1vid) + compute_acc(output_v2, view2vid)
        # loss
...
def test(epoch):
    ...
    for batch_idx, (view1vid, view2vid) in enumerate(testloader):
        ...
        with torch.no_grad():
            ...
            recon2_loss = criterion(output_v2, view2vid)
            loss = con_loss + recon1_loss + recon2_loss
            if con_loss < CON_LOSS_THRESHOLD:
                loss = recon1_loss + recon2_loss
    ...
    return running_total_loss, running_con_loss, running_recon1_loss, running_recon2_loss
...
def train_model():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        train(epoch)
        print('Validation...')
        loss, con_loss, recon1_loss, recon2_loss = test(epoch)
