...
class IntermediateGen(nn.Module):
    """
    ...
    def __init__(self, in_channels, out_frames, gen_name='Intermediate Generator'):
        """
        ...
        :param out_frames: (int) The number of frames desired in the generated output video.
                            Legal values: 8, 16
        :param gen_name: (str, optional) The name of the network (default 'Intermediate Generator').
        Raises:
        ...
        super(IntermediateGen, self).__init__()
        ...
        self.conv3d_2a = nn.Conv3d(in_channels=32, out_channels=16, kernel_size=(3, 3, 3),
                                   stride=(1, 1, 1), padding=(1, 1, 1))
        self.conv3d_2b = nn.Conv3d(in_channels=16, out_channels=3, kernel_size=(3, 3, 3),
                                   stride=(1, 1, 1), padding=(1, 1, 1))
...
if __name__ == "__main__":
    ...
    gen = IntermediateGen(in_channels=1, out_frames=16)
