...
class Expander(nn.Module):
    ...
    def __init__(self, vp_value_count, out_size, ex_name='Viewpoint Expander'):
        """
        ...
        self.conv2d_1a = nn.Conv2d(in_channels=self.vp_value_count, out_channels=4, kernel_size=(3, 3),
                                   stride=(1, 1), padding=(1, 1))
        self.conv2d_1b = nn.Conv2d(in_channels=4, out_channels=self.vp_value_count, kernel_size=(3, 3),
                                   stride=(1, 1), padding=(1, 1))
    ...
    def expand_vp(self, vp):
        ...
        buffer = torch.zeros(bsz, self.vp_value_count, self.out_size, self.out_size)
