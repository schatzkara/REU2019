...
def ntu_config():
    ...
    weights_path = './weights/netnewgen_ntu_{}_{}_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                               PRECROP, CLOSE_VIEWS, 1000,
                                                                               0.0001, STDEV)
...
def panoptic_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weights_path = './weights/netnewgen_pan_{}_{}_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                               PRECROP, CLOSE_VIEWS, 1000,
                                                                               0.0001, STDEV)
    if not os.path.exists('./videos'):
        os.mkdir('./videos')
