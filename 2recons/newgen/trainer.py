...
def ntu_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weight_file = './weights/netnewgen_ntu_{}_{}_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                              PRECROP, CLOSE_VIEWS, NUM_EPOCHS,
                                                                              LR, STDEV)
...
def panoptic_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weight_file = './weights/netnewgen_pan_{}_{}_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                              PRECROP, CLOSE_VIEWS, NUM_EPOCHS,
                                                                              LR, STDEV)
