...
class FullNetwork(nn.Module):
    ...
    def __init__(self, vp_value_count, output_shape, stdev, name='Full Network'):
        ...
        self.gen = Generator(in_channels=[self.rep_channels, self.nkp, self.rep_channels],
    ...
    def forward(self, vp_diff, vid1, vid2, img1, img2):
        ...
        app_v1, app_v2 = self.appearance_pipeline(img1, img2)  # bsz,256,14,14
        ...
        rep_v1, rep_v2, rep_v1_est, rep_v2_est, kp_v1, kp_v2, kp_v1_est, kp_v2_est = self.action_pipeline(vp1_to_2,
                                                                                                          vp2_to_1,
                                                                                                          vid1, vid2)
        # bsz,256,4,14,14; bsz,32,16,28,28

        # del vid1, vid2
        del vp1_to_2, vp2_to_1
        ...
        gen_v1, gen_v2 = self.gen(app_v1, kp_v1_est, rep_v1_est), self.gen(app_v2, kp_v2_est, rep_v2_est)
        # bsz,3,16,112,112
    ...
    def action_pipeline(self, vp1_to_2, vp2_to_1, vid1, vid2):
        ...
        kp_v1_est, kp_v2_est = self.kpp(rep_v1_est), self.kpp(rep_v2_est)  # bsz,32,16,28,28
...
if __name__ == "__main__":
    ...
    if print_summary:
        summary(net, input_size=[(1), (3, 8, 112, 112), (3, 8, 112, 122), (3, 112, 122), (3, 112, 122)])
