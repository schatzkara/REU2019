...
class KPPredictor(nn.Module):
    ...
    def __init__(self, in_channels=256, nkp=32, stdev=0.1, kpp_name='Key-Point Predictor'):
        ...
        self.conv3d_1 = nn.Conv3d(in_channels=in_channels, out_channels=64, kernel_size=(3, 3, 3),
                                  stride=(1, 1, 1), padding=(1, 1, 1))
        self.relu1 = nn.ReLU(inplace=True)
        self.conv3d_2 = nn.Conv3d(in_channels=64, out_channels=64, kernel_size=(3, 3, 3),
                                  stride=(1, 1, 1), padding=(1, 1, 1))
