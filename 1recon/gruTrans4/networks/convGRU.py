...
class ConvGRUCell(nn.Module):
    ...
    def forward(self, input_tensor, mf, kp, h_cur):
        """
        :param self:
    ...
    @staticmethod
    def warp_app_feat(app_feat, flow):
        flow = flow.permute(0, 2, 3, 1)
        warped_app = f.grid_sample(input=app_feat, grid=flow)
...
class ConvGRU(nn.Module):
    ...
    def forward(self, input_tensor, mf, kp, hidden_state=None):
        """
