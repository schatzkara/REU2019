...
class ConvLSTMCell(nn.Module):
    ...
    def init_hidden(self, batch_size, height, width):
        ...
        y = torch.zeros(batch_size, self.hidden_dim, height, width)
...
class ConvLSTM(nn.Module):
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if hidden_state is not None:
            ...
            hidden_state = self._init_hidden(batch_size=bsz, height=height, width=width)
...
if __name__ == '__main__':
    conv_lstm = ConvLSTM(input_dim=16, hidden_dim=256, kernel_size=(3, 3), num_layers=1,
                         batch_first=True, bias=False, return_all_layers=True)

    summary(conv_lstm, input_size=(4, 16, 14, 14))
