...
class Generator(nn.Module):
    ...
    def __init__(self, in_channels, out_frames, gen_name='Video Generator'):
        ...
        layer_in_channels = {'conv_1a': sum(in_channels),
                             ...
                             'conv_2a': layer_out_channels['conv_1b'] + in_channels[1],  # + 256
                             'conv_2b': layer_out_channels['conv_2a'],
                             'conv_3a': layer_out_channels['conv_2b'] + in_channels[1],  # + 128
    ...
    def forward(self, app, rep):
        ...
        """
        # block 1
        app_block_input = self.replicate_app(app, frames=4)
        ...
        x = torch.cat([rep_block_input, x], dim=1)
