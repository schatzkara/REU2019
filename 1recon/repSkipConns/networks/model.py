...
class FullNetwork(nn.Module):
    ...
    def __init__(self, vp_value_count, output_shape, name='Full Network'):
        ...
        self.conv64 = nn.Conv3d(in_channels=64, out_channels=128, kernel_size=(3, 3, 3), stride=(1, 1, 1),
                                padding=(1, 1, 1))
        self.conv192 = nn.Conv3d(in_channels=192, out_channels=128, kernel_size=(3, 3, 3), stride=(1, 1, 1),
                                 padding=(1, 1, 1))
        self.conv256 = nn.Conv3d(in_channels=256, out_channels=128, kernel_size=(3, 3, 3), stride=(1, 1, 1),
                                 padding=(1, 1, 1))
        self.rep_convs = {64: self.conv64,
                          192: self.conv192,
                          256: self.conv256}

        self.trans = Transformer(in_channels=128 + self.vp_value_count, out_channels=256)
    ...
    def forward(self, vp_diff, vid1, img2):
        ...
        rep_v2_est = self.action_pipeline(vp_diff, vid1)  # bsz,256,4,14,14
