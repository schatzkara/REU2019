...
def ntu_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weight_file = './weights/net6_ntu_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
...
def panoptic_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weight_file = './weights/net6_pan_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                   PRECROP, NUM_EPOCHS, LR)
