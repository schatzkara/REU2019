...
def training_loop(epoch):
    ...
    print('Training Epoch {}/{} Loss:{} con1app:{} con2app:{} con1kp:{} con2kp:{} recon1:{} recon2:{}'.format(
        epoch + 1,
        NUM_EPOCHS,
        "{0:.5f}".format((running_total_loss / len(trainloader))),
        "{0:.5f}".format((running_con1app_loss / len(trainloader))),
        "{0:.5f}".format((running_con2app_loss / len(trainloader))),
        "{0:.5f}".format((running_con1kp_loss / len(trainloader))),
        "{0:.5f}".format((running_con2kp_loss / len(trainloader))),
...
def testing_loop(epoch):
    ...
    print('Validation Epoch {}/{} Loss:{} con1app:{} con2app:{} con1kp:{} con2kp:{} recon1:{} recon2:{}'.format(
        epoch + 1,
        NUM_EPOCHS,
