...
class FullNetwork(nn.Module):
    ...
    def forward(self, vp_diff, vid1, vid2, img1, img2):
        ...
        rep_v1, rep_v2, rep_v1_est, rep_v2_est = self.action_pipeline(vp1, vp2, vid1, vid2)  # bsz,32,8/16,14,14
        ...
        return gen_v1, gen_v2, recon_v1, recon_v2, rep_v1, rep_v2, rep_v1_est, rep_v2_est
    ...
    def action_pipeline(self, vp1, vp2, vid1, vid2):
        ...
        return rep_v1, rep_v2, rep_v1_est, rep_v2_est
