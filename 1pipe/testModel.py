...
def ntu_config():
    ...
    weights_path = './weights/net1pipe_ntu_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                        PRECROP, 1000, 0.0001)
    output_video_dir = './videos/ntu_net1pipe_'
...
def panoptic_config():
    ...
    if not os.path.exists('./weights'):
        os.mkdir('./weights')
    weights_path = './weights/net1pipe_pan_{}_{}_{}_{}_{}_{}.pt'.format(BATCH_SIZE, FRAMES, SKIP_LEN,
                                                                        PRECROP, 1000, 0.0001)
    output_video_dir = './videos/pan_net1pipe_'
